		...
		>
			...
			<Stack>
				...
				>
					...
					<Box
						width="100%"
						background="--color-lightD2 url(https://uploads.quarkly.io/5faede1f08b41a001fec186f/images/AD01-700px.gif?v=2020-11-13T20:34:49.277Z) center center/100% no-repeat"
						margin="0px 0px 0px 0px"
			...
			<Stack margin="80px -16px -16px -16px" lg-margin="50px -16px -16px -16px" md-margin="30px -16px -16px -16px">
				...
				>
					...
					<Box
						width="100%"
						background="--color-lightD2 url(https://uploads.quarkly.io/5faede1f08b41a001fec186f/images/AD05-city-rain.gif?v=2020-11-13T20:35:44.853Z) center center/100% no-repeat"
						margin="0px 0px 0px 0px"
						padding="0px 0px 60% 0px"
						height="0px"
						hover-background="--color-lightD2 url(https://artemzhigalin.ru/src/default-website-illustration-sea.svg) center center/110% no-repeat"
			...
			<Stack margin="80px -16px -16px -16px" lg-margin="50px -16px -16px -16px" md-margin="30px -16px -16px -16px">
				...
				>
					...
					<Box
						width="100%"
						background="--color-lightD2 url(https://uploads.quarkly.io/5faede1f08b41a001fec186f/images/AD05-city.gif?v=2020-11-13T20:36:20.525Z) center center/100% no-repeat"
						margin="0px 0px 0px 0px"
						padding="0px 0px 60% 0px"
						height="0px"
						hover-background="--color-lightD2 url(https://artemzhigalin.ru/src/default-website-illustration-sea.svg) center center/110% no-repeat"
